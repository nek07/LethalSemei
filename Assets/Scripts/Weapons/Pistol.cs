...
public class Pistol : Gun
{
    ...
    {
        base.Update();
        Debug.DrawRay(camerTransform.position, camerTransform.forward, Color.red);
    ...
    public override void Shoot()
    {
        ...
        if (Physics.Raycast(camerTransform.position, camerTransform.forward + d_currentRecoil, out hit, gunData.shootingRange,
        ...
        {
            target = camerTransform.position + (camerTransform.forward + d_currentRecoil) * gunData.shootingRange;
        }
    ...
    private void BulletHitFX(RaycastHit hit)
    {
        ...
        GameObject hitParticle = Instantiate(bulletParticlePrefab, hit.point, Quaternion.LookRotation(hit.normal));

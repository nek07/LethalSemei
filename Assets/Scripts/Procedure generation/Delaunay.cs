...
public class Delaunay {
    ...
    public class Triangle {
        ...
        public static bool AlmostEqual(Triangle left, Triangle right) {
            return (Delaunay.AlmostEqual(left.U, right.U) || Delaunay.AlmostEqual(left.U, right.V) || Delaunay.AlmostEqual(left.U, right.W))
                && (Delaunay.AlmostEqual(left.V, right.U) || Delaunay.AlmostEqual(left.V, right.V) || Delaunay.AlmostEqual(left.V, right.W))
                && (Delaunay.AlmostEqual(left.W, right.U) || Delaunay.AlmostEqual(left.W, right.V) || Delaunay.AlmostEqual(left.W, right.W));
        }
    }
    ...
    public class Edge {
        ...
        public static bool AlmostEqual(Edge left, Edge right) {
            return (Delaunay.AlmostEqual(left.U, right.U) || Delaunay.AlmostEqual(left.V, right.U))
